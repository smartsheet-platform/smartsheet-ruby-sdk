module Smartsheet
  class Webhooks
    ...
    def delete(webhook_id:, header_overrides: {})
    ...
    def get(webhook_id:, header_overrides: {})
    ...
    def reset_shared_secret(webhook_id:, header_overrides: {})
    ...
    def update(webhook_id:, body:, header_overrides: {})
