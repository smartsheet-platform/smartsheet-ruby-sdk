    ...
    [
        {
            ...
            has_params: true,
            expected_params: {'grant_type': 'authorization_code', client_id: '123', code: '234', hash: '345'},
            headers: nil
        },
        {
            symbol: :refresh,
            ...
            has_params: true,
            expected_params: {'grant_type': 'refresh_token', client_id: '123', refresh_token: '234', hash: '345'},
            headers: nil
        },
        {
            symbol: :revoke,
